...
-- テストユーザーの挿入
INSERT INTO users (name, affiliation, password_hash, icon_url) VALUES
('田中 太郎', 'Dev部門', '$2a$10$dummyhash1111111111111111111111111111111111111111', 'https://i.pravatar.cc/150?img=1'),
('佐藤 花子', 'MKT部門', '$2a$10$dummyhash2222222222222222222222222222222222222222', 'https://i.pravatar.cc/150?img=2'),
('鈴木 一郎', 'Ops部門', '$2a$10$dummyhash3333333333333333333333333333333333333333', 'https://i.pravatar.cc/150?img=3'),
('高橋 美咲', 'Dev部門', '$2a$10$dummyhash4444444444444444444444444444444444444444', 'https://i.pravatar.cc/150?img=4');
